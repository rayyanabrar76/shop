...
export async function POST(
  ...
  const data = {
    ...
    heroHeight:      body.heroHeight      ?? undefined,
    heroPosition:    body.heroPosition    ?? undefined,
    heroButton:      body.heroButton      ?? undefined,
    cardShadow:      body.cardShadow      ?? undefined,
    dividerStyle:    body.dividerStyle    ?? undefined,
    shopAllLabel:    body.shopAllLabel    ?? undefined,
    shopAllShow:       body.shopAllShow       ?? undefined,
    shopAllPadTop: body.shopAllPadTop ?? undefined,
    shopAllPadBottom: body.shopAllPadBottom ?? undefined,
    shopAllPadLeft: body.shopAllPadLeft ?? undefined,
    shopAllPadRight: body.shopAllPadRight ?? undefined,
    shopAllMarginTop: body.shopAllMarginTop ?? undefined,
    shopAllMarginBottom: body.shopAllMarginBottom ?? undefined,
    featuredLabelShow: body.featuredLabelShow ?? undefined,
    shopAllStyle:      body.shopAllStyle      ?? undefined,
    featuredLabelPadTop: body.featuredLabelPadTop ?? undefined,
    featuredLabelPadBottom: body.featuredLabelPadBottom ?? undefined,
    featuredLabelPadLeft: body.featuredLabelPadLeft ?? undefined,
    featuredLabelPadRight: body.featuredLabelPadRight ?? undefined,
    featuredLabelMarginTop: body.featuredLabelMarginTop ?? undefined,
    featuredLabelMarginBottom: body.featuredLabelMarginBottom ?? undefined,
    ...
    productGridPadTop: body.productGridPadTop ?? undefined,
    productGridPadBottom: body.productGridPadBottom ?? undefined,
    productGridPadLeft: body.productGridPadLeft ?? undefined,
    productGridPadRight: body.productGridPadRight ?? undefined,
    productGridMarginTop: body.productGridMarginTop ?? undefined,
    productGridMarginBottom: body.productGridMarginBottom ?? undefined,
