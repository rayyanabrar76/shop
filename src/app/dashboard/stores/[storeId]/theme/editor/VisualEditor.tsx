...
export default function VisualEditor({
  ...
  const [theme, setTheme] = useState<ThemeState>({
    ...
    shopAllShow:         initialTheme?.shopAllShow         ?? true,
    shopAllPadTop: initialTheme?.shopAllPadTop ?? 12,
    shopAllPadBottom: initialTheme?.shopAllPadBottom ?? 12,
    shopAllPadLeft: initialTheme?.shopAllPadLeft ?? 32,
    shopAllPadRight: initialTheme?.shopAllPadRight ?? 32,
    shopAllMarginTop: initialTheme?.shopAllMarginTop ?? 0,
    shopAllMarginBottom: initialTheme?.shopAllMarginBottom ?? 32,
    featuredLabelShow:   initialTheme?.featuredLabelShow   ?? true,
    shopAllStyle:        initialTheme?.shopAllStyle        ?? '',
    featuredLabelPadTop: initialTheme?.featuredLabelPadTop ?? 0,
    featuredLabelPadBottom: initialTheme?.featuredLabelPadBottom ?? 0,
    featuredLabelPadLeft: initialTheme?.featuredLabelPadLeft ?? 0,
    featuredLabelPadRight: initialTheme?.featuredLabelPadRight ?? 0,
    featuredLabelMarginTop: initialTheme?.featuredLabelMarginTop ?? 0,
    featuredLabelMarginBottom: initialTheme?.featuredLabelMarginBottom ?? 28,
    ...
    productGridPadTop: initialTheme?.productGridPadTop ?? 24,
    productGridPadBottom: initialTheme?.productGridPadBottom ?? 24,
    productGridPadLeft: initialTheme?.productGridPadLeft ?? 0,
    productGridPadRight: initialTheme?.productGridPadRight ?? 0,
    productGridMarginTop: initialTheme?.productGridMarginTop ?? 0,
    productGridMarginBottom: initialTheme?.productGridMarginBottom ?? 0,
