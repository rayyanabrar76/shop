          ...
          <div className="grid grid-cols-3 md:grid-cols-4 gap-3">
            {media.map((m: MediaAsset) => (
              ...
              >
                ...
                <div onClick={e => onDelete(m.id, e)} className="absolute top-1.5 left-1.5 p-1 rounded-md bg-black/50 text-white opacity-0 group-hover:opacity-100 hover:bg-red-500 transition-all cursor-pointer">
